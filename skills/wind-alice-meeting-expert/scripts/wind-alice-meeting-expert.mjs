...
if (isHelp) {
  console.log(
    [
      "wind-alice-meeting-expert — 调用万得 Alice Agent，执行指定 Skill 并流式输出分析结果",
      "",
      "Usage:",
      '  wind-alice-meeting-expert --prompt <QUESTION> [--skill <SKILL_NAME>]',
      "  wind-alice-meeting-expert list-skills",
      ...
      "",
      "Examples (PowerShell):",
      '  wind-alice-meeting-expert --prompt "贵州茅台" --skill "上市公司调研问题清单"',
      '  wind-alice-meeting-expert --prompt "贵州茅台" --skill "Stock DD List"',
      '  wind-alice-meeting-expert -p "贵州茅台 600519" -s "公司一页纸"',
      "  wind-alice-meeting-expert list-skills",
      "",
      "Config:",
