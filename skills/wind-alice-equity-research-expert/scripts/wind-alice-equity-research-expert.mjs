...
if (isHelp) {
  console.log(
    [
      ...
      "",
      "Examples (PowerShell):",
      '  wind-alice-equity-research-expert --prompt "贵州茅台" --skill "上市公司调研问题清单"',
      '  wind-alice-equity-research-expert --prompt "贵州茅台" --skill "Stock DD List"',
      '  wind-alice-equity-research-expert -p "贵州茅台 600519" -s "公司一页纸"',
      "  wind-alice-equity-research-expert list-skills",
      "",
      "Config:",
